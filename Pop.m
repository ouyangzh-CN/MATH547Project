...
loc_m=xlsread('Pop.xlsx','male','A2:A9983');
year_m=xlsread('Pop.xlsx','male','D2:D9983');
mean_m=xlsread('Pop.xlsx','male','K2:K9983');

loc_f=xlsread('Pop.xlsx','female','A2:A9983');
year_f=xlsread('Pop.xlsx','female','D2:D9983');
mean_f=xlsread('Pop.xlsx','female','K2:K9983');

loc_b=xlsread('Pop.xlsx','both','A2:A9983');
year_b=xlsread('Pop.xlsx','both','D2:D9983');
mean_b=xlsread('Pop.xlsx','both','K2:K9983');
...
%     if c==137
%         year_f1=[year_f1(1:25);1995;year_f1(26:end)];
%         mean_f1=[mean_f1(1:25);3.34;mean_f1(26:end)];
%     end
    if(~isempty(idx2))
...
xlabel('Year'); 
ylabel('Male Population Weighted Education Years Per Capita');
hold off
...
legend([s1,s2,s3,s4,s5],'China','UK','Canada','India','Sudan')
xlabel('Year'); 
ylabel('Female Population Weighted Education Years Per Capita');
hold off
...
legend([s1,s2,s3,s4,s5],'China','UK','Canada','India','Sudan')
xlabel('Year'); 
ylabel('Population Weighted Education Years Per Capita');
hold off
...
legend([s1,s2,s3,s4,s5],'China','UK','Canada','India','Sudan')
xlabel('Year'); 
ylabel('Population Weighted Male-Female Education Ratio');
hold off
